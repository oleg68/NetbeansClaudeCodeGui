...
- [ ] JediTerm не наследует настройки темы из Tools->Options->Appearance->Look and Feel
- [ ] Markdown preview в тёмной теме не читаемы. Нужно брать цвета выделений тоже из темы
- [ ] Если есть отмеченные опции, то они отображаются как радиокнопки вместо чекбоксов
    ```
    ←  ☒ Релизы  ✔ Submit  →

    Для каких релизов применить обновление agnostic до 1.3.2132?
      ...
      3. [ ] 2025.3
      Целевая ветка: release/2025.3 (нет в origin — создать от тега)
      4. [ ] 2025.2
