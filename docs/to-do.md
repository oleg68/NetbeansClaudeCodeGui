...
- [x] Drag and drop in a text field: вставлять в текущую позицию курсора, а не
...
- [x] Previe markdown: не показываются изображения
- [x] Previe markdown: не работает навигация по линкам внутри файла
